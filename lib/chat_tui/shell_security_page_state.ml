...
let empty_snapshot =
  ...
  ; manifest_grants = []
  ; grants = []
  ; administrative_policy = "builtin:permissive"
...
let empty () =
  ...
  ; approval_modal = None
  ; grant_revoke_modal = None
  ; moderator_modal = None
  ; audit_load_state = Audit_not_loaded
  ; selected_audit_request_id = None
  ; next_management_generation = 0
  }
;;
