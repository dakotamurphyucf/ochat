...
let reaction_to_string (r : Chat_tui.Controller.reaction) : string =
  ...
  | Chat_tui.Controller.Chat_scrolled changed -> sprintf "Chat_scrolled(%b)" changed
  | Chat_tui.Controller.Prepare_chat_destination _ -> "Prepare_chat_destination"
  | Chat_tui.Controller.Shell_approval_response _ -> "Shell_approval_response"
  | Chat_tui.Controller.Shell_grant_revoke_requested _ -> "Shell_grant_revoke_requested"
  | Chat_tui.Controller.Shell_management_refresh_requested _ ->
    "Shell_management_refresh_requested"
  | Chat_tui.Controller.Moderator_input_response _ -> "Moderator_input_response"
