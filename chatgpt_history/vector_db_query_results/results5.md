Querying indexed OCaml code with text: **let corpus docs = Vector_db.**
...
```ocaml
(** 
Location: File "vector_db.ml", line 113, characters 0-160
Module Path: Vector_db
OCaml Source: Implementation
*)
 ...
 *)
let get_docs env t indexs =
  Array.map
    ~f:(fun idx ->
      let file_path = Hashtbl.find_exn t.index idx in
      Doc.load_prompt env file_path)
    indexs
```
...
```ocaml
(** 
Location: File "vector_db.mli", line 89, characters 0-70
Module Path: Vector_db
OCaml Source: Interface
*)
