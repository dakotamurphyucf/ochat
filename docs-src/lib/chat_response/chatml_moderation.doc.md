...
Shared moderator vocabulary, runtime requests and state effects. The agent actor owns durable application; a connected TUI renders the resulting projection.
...
[Interface](../../../lib/chat_response/chatml_moderation.mli) · [implementation](../../../lib/chat_response/chatml_moderation.ml)
