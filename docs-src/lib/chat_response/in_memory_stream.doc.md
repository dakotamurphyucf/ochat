...
Shared streaming/moderation boundary. Cancellation and sourced/history-correlated deltas are distinct from durable actor history; adapters must not replay finalized rows as duplicate tool progress.
...
[Interface](../../../lib/chat_response/in_memory_stream.mli) · [implementation](../../../lib/chat_response/in_memory_stream.ml)
