...
Shared provider/tool execution with host-injected semantic control. Agent-server workers use this runtime without transferring session ownership to a TUI.
...
[Interface](../../../lib/chat_response/agent_runtime.mli) · [implementation](../../../lib/chat_response/agent_runtime.ml)
