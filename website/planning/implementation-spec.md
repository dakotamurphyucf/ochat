...
- [ ] **P10.11 — Verify actual release enforcement.** Confirm required checks and input watch paths cannot be bypassed by the production trigger; distinguish preview and production artifact hashes, origins, and indexing behavior.
